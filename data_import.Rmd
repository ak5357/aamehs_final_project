...
mat.age = read_csv("data/mother_clean.csv") |> 
  ...
  mutate(
    ...
    birthing_rate = ifelse(total > 0, total_birth / total, 0), # percent of people able to give birth who actually gave birth
    avg_birthing_age = ifelse(total > 0, (17*birth_15_19 + 22*birth_20_24 + 27*birth_25_29 + 32*birth_30_34 + 42*birth_40_44 + 47.5*birth_45_50) / total_birth, NA_real_)
  ) |> 
  rename(total_birth_pop = total, total_birth_count = total_birth) |> 
  select(geo_id, total_birth_pop, total_birth_count, birthing_rate, avg_birthing_age)
```
